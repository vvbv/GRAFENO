...
_MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "app.no_clis": "No supported agent CLI detected (opencode, kimi, codex, claude, cursor, minimax). You can configure GRAFENO, but no task can run until you install one.",
        "common.quit": "Quit",
        ...
        "tasks.bind.consoles": "Consoles",
        "tasks.bind.done": "Completed",
        "tasks.bind.date": "Date",
        "tasks.scope.project": "Project tasks",
        "tasks.scope.all": "All tasks",
        "tasks.done.all": "All states",
        "tasks.done.hide": "Hide completed",
        "tasks.done.only": "Only completed",
        "tasks.date.today": "Today",
        "tasks.date.all_dates": "All dates",
        "tasks.date.placeholder": "Date YYYY-MM-DD",
        "tasks.date.bad_date": "Invalid date: use the YYYY-MM-DD format",
        "tasks.quit_hint": "Closing with q is disabled: press {key} to quit",
        "tasks.error.load": "Could not load task: {error}",
        "tasks.bind.reports": "Reports",
        "reports.subtitle": "Usage report · tokens, models, time and projects",
        "reports.period.today": "Today",
        "reports.period.week": "This week",
        "reports.period.month": "This month",
        "reports.period.apply": "Apply",
        "reports.from.placeholder": "From YYYY-MM-DD",
        "reports.to.placeholder": "To YYYY-MM-DD",
        "reports.range.day": "Period: {day}",
        "reports.range": "Period: {start} → {end}",
        "reports.summary": "Tokens: ↑{tokens_in} ↓{tokens_out} · Time: {duration} · Tasks: {tasks} · Projects: {projects}",
        "reports.empty": "No usage recorded in this period.",
        "reports.error.bad_date": "Invalid date: use the YYYY-MM-DD format",
        "reports.section.by_day": "By day",
        "reports.section.by_model": "By CLI + model",
        "reports.section.by_project": "By project",
        "reports.col.date": "Date",
        "reports.col.model": "CLI/model",
        "reports.col.project": "Project",
        "reports.col.tokens_in": "Tokens ↑in",
        "reports.col.tokens_out": "Tokens ↓out",
        "reports.col.time": "Time",
        "reports.col.tasks": "Tasks",
        # modal nueva tarea
        "nt.title": "New task",
        "nt.name": "Name",
        ...
        "nt.workdir.remote": "Remote project path",
        "nt.workdir.remote.placeholder": "/home/user/myproject",
        "nt.error.bad_remote_dir": "Enter an absolute path on the remote host (starting with / or ~).",
        ...
        "cfg.self_update.enabled": "Update GRAFENO automatically when a new GitHub release is detected",
        ...
        "cfg.workspaces.help": "Root folders scanned for projects: each first-level subfolder is listed as a project even without tasks.",
        "cfg.workspaces.label": "Folders (comma-separated)",
        ...
        "roles.profile.none": "Custom (no profile)",
         "det.profile": "Profile",
         "det.models_missing": "Model no longer available in this task: {items}",
         "modelcheck.role.parser": "Telegram parser",
         "modelcheck.missing": "{roles}: {pair} is no longer available",
         "modelcheck.missing_profile": "{roles} (profile '{profile}'): {pair} is no longer available",
        ...
        "consoles.new": "New",
        "consoles.edit": "Edit",
        "consoles.delete": "Delete",
        "consoles.interrupt": "Ctrl+C",
        "consoles.empty": "No consoles defined for this project. Use the New button to create the first one.",
        "consoles.unsupported": "Consoles are only available on POSIX systems (Linux/macOS).",
        "consoles.exited": "[process exited with code {code} - click the tab to reopen]",
        "consoles.error.spawn": "Could not start the console: {error}",
        "consoles.error.save": "Could not save the project consoles: {error}",
        "consoles.warn.not_running": "The console process is not running; click its tab to reopen it.",
        "consoles.deleted": "Console '{name}' deleted.",
        "consoles.input.placeholder": "Type a command and press Enter",
        "consoles.form.title.new": "New console",
        "consoles.form.title.edit": "Edit console",
        "consoles.form.name": "Name",
        "consoles.form.command": "Command (empty = default shell)",
        "consoles.form.color": "Color",
        "consoles.color.default": "Default",
        "consoles.color.red": "Red",
        "consoles.color.green": "Green",
        "consoles.color.yellow": "Yellow",
        "consoles.color.blue": "Blue",
        ...
        "media.opened": "Opened {name} with the system viewer",
        ...
        "det.no_clis": "No agent CLI installed: install opencode, kimi, codex, claude, cursor or minimax (mcode) to run tasks.",
        ...
        "supd.done": "GRAFENO updated to v{version}. Restart the app to apply.",
        ...
        # remote session mode (grafeno [user@]host)
        "rsession.no_tool": "Required tool not found: {tool} (needed for remote sessions).",
        "rsession.connect.fail": "Could not connect to {target} over ssh.",
        "rsession.mount.fail": "Could not mount the remote ~/.grafeno of {target}.",
        ...
        "tg.filter.ask": "Which tasks do you want to see?",
        "tg.filter.pick": "Tap states to toggle them, then press Show:",
        "tg.filter.all": "all states",
        "tg.filter.active": "all except completed",
        "tg.filter.selected": "states: {states}",
        "tg.filter.header": "Tasks ({filter}):\n{items}",
        "tg.filter.header_project": "Tasks of {workdir} ({filter}):\n{items}",
        "tg.filter.none_selected": "No state selected: tap at least one state or choose All.",
        "tg.btn.filter_all": "All",
        "tg.btn.filter_active": "All except completed",
        "tg.btn.filter_pick": "Choose states",
        "tg.btn.filter_show": "Show",
        "tg.projects.empty": "No projects yet (no tasks and no workspaces configured).",
        "tg.projects.header": "Projects:\n{items}",
        "tg.projects.item": "• {workdir} — {count} task(s)",
        "tg.projects.item_empty": "• {workdir} — no tasks yet",
    ...
    "es": {
        ...
        "app.bind.theme": "Tema",
        "app.no_clis": "No se detecta ningún CLI de agente soportado (opencode, kimi, codex, claude, cursor, minimax). Puedes configurar GRAFENO, pero ninguna tarea podrá ejecutarse hasta que instales alguno.",
        "common.quit": "Salir",
        ...
        "tasks.bind.consoles": "Consolas",
        "tasks.bind.done": "Completadas",
        "tasks.bind.date": "Fecha",
        "tasks.scope.project": "Tareas del proyecto",
        "tasks.scope.all": "Todas las tareas",
        "tasks.done.all": "Todos los estados",
        "tasks.done.hide": "Ocultar completadas",
        "tasks.done.only": "Solo completadas",
        "tasks.date.today": "Hoy",
        "tasks.date.all_dates": "Todas las fechas",
        "tasks.date.placeholder": "Fecha AAAA-MM-DD",
        "tasks.date.bad_date": "Fecha no válida: usa el formato AAAA-MM-DD",
        "tasks.quit_hint": "No se puede salir con q: pulsa {key} para cerrar",
        "tasks.error.load": "No se pudo cargar la tarea: {error}",
        "tasks.bind.reports": "Reportes",
        "reports.subtitle": "Reporte de uso · tokens, modelos, tiempo y proyectos",
        "reports.period.today": "Hoy",
        "reports.period.week": "Semana actual",
        "reports.period.month": "Mes actual",
        "reports.period.apply": "Aplicar",
        "reports.from.placeholder": "Desde AAAA-MM-DD",
        "reports.to.placeholder": "Hasta AAAA-MM-DD",
        "reports.range.day": "Período: {day}",
        "reports.range": "Período: {start} → {end}",
        "reports.summary": "Tokens: ↑{tokens_in} ↓{tokens_out} · Tiempo: {duration} · Tareas: {tasks} · Proyectos: {projects}",
        "reports.empty": "Sin uso registrado en este período.",
        "reports.error.bad_date": "Fecha no válida: usa el formato AAAA-MM-DD",
        "reports.section.by_day": "Por día",
        "reports.section.by_model": "Por CLI + modelo",
        "reports.section.by_project": "Por proyecto",
        "reports.col.date": "Fecha",
        "reports.col.model": "CLI/modelo",
        "reports.col.project": "Proyecto",
        "reports.col.tokens_in": "Tokens ↑ent",
        "reports.col.tokens_out": "Tokens ↓sal",
        "reports.col.time": "Tiempo",
        "reports.col.tasks": "Tareas",
        ...
        "nt.workdir.remote": "Ruta del proyecto en el remoto",
        "nt.workdir.remote.placeholder": "/home/usuario/miproyecto",
        "nt.error.bad_remote_dir": "Introduce una ruta absoluta en el host remoto (que empiece por / o ~).",
        ...
        "cfg.self_update.enabled": "Actualizar GRAFENO automáticamente al detectar una release nueva en GitHub",
        ...
        "cfg.workspaces": "Espacios de trabajo",
        "cfg.workspaces.help": "Carpetas raíz donde buscar proyectos: cada subcarpeta de primer nivel se lista como proyecto aunque no tenga tareas.",
        "cfg.workspaces.label": "Carpetas (separadas por comas)",
        ...
        "roles.profile.none": "Personalizado (sin perfil)",
         "det.profile": "Perfil",
         "det.models_missing": "Modelo ya no disponible en esta tarea: {items}",
         "modelcheck.role.parser": "Intérprete de Telegram",
         "modelcheck.missing": "{roles}: {pair} ya no está disponible",
         "modelcheck.missing_profile": "{roles} (perfil '{profile}'): {pair} ya no está disponible",
        ...
        "consoles.new": "Nueva",
        "consoles.edit": "Editar",
        "consoles.delete": "Borrar",
        "consoles.interrupt": "Ctrl+C",
        "consoles.empty": "No hay consolas definidas para este proyecto. Usa el botón Nueva para crear la primera.",
        "consoles.unsupported": "Las consolas solo están disponibles en sistemas POSIX (Linux/macOS).",
        "consoles.exited": "[proceso terminado con código {code} - pulsa la pestaña para reabrir]",
        "consoles.error.spawn": "No se pudo iniciar la consola: {error}",
        "consoles.error.save": "No se pudieron guardar las consolas del proyecto: {error}",
        "consoles.warn.not_running": "El proceso de la consola no está en ejecución; pulsa su pestaña para reabrirla.",
        "consoles.deleted": "Consola '{name}' borrada.",
        "consoles.input.placeholder": "Escribe un comando y pulsa Enter",
        "consoles.form.title.new": "Nueva consola",
        "consoles.form.title.edit": "Editar consola",
        "consoles.form.name": "Nombre",
        "consoles.form.command": "Comando (vacío = shell por defecto)",
        "consoles.form.color": "Color",
        "consoles.color.default": "Por defecto",
        "consoles.color.red": "Rojo",
        "consoles.color.green": "Verde",
        "consoles.color.yellow": "Amarillo",
        "consoles.color.blue": "Azul",
        "consoles.color.magenta": "Magenta",
        ...
        "det.tab.media": "Media",
        "media.path": "Ruta: {path}",
        "media.opened": "Abierto {name} con el visor del sistema",
        ...
        "det.no_clis": "No hay ningún CLI de agente instalado: instala opencode, kimi, codex, claude, cursor o minimax (mcode) para ejecutar tareas.",
        ...
        "supd.done": "GRAFENO actualizado a v{version}. Reinicia la app para aplicar.",
        ...
        # modo sesión remota (grafeno [usuario@]host)
        "rsession.no_tool": "Herramienta requerida no encontrada: {tool} (necesaria para sesiones remotas).",
        "rsession.connect.fail": "No se pudo conectar con {target} por ssh.",
        "rsession.mount.fail": "No se pudo montar el ~/.grafeno remoto de {target}.",
        ...
        "tg.list.item": "• {name} — {state} ({id})",
        "tg.filter.ask": "¿Qué tareas quieres ver?",
        "tg.filter.pick": "Toca los estados para marcarlos o desmarcarlos y pulsa Mostrar:",
        "tg.filter.all": "todos los estados",
        "tg.filter.active": "todas menos completadas",
        "tg.filter.selected": "estados: {states}",
        "tg.filter.header": "Tareas ({filter}):\n{items}",
        "tg.filter.header_project": "Tareas de {workdir} ({filter}):\n{items}",
        "tg.filter.none_selected": "No has marcado ningún estado: toca al menos uno o elige Todas.",
        "tg.btn.filter_all": "Todas",
        "tg.btn.filter_active": "Todas menos completadas",
        "tg.btn.filter_pick": "Elegir estados",
        "tg.btn.filter_show": "Mostrar",
        "tg.projects.empty": "Aún no hay proyectos (sin tareas ni espacios de trabajo configurados).",
        "tg.projects.header": "Proyectos:\n{items}",
        "tg.projects.item": "• {workdir} — {count} tarea(s)",
        "tg.projects.item_empty": "• {workdir} — sin tareas aún",
